...
UPDATE linha
  SET desc_linha = REPLACE (desc_linha, 'T. LARANJEIRAS / T. IBES VIA 3ª PONTE/RETA DA PENHA','T.LARANJEIRAS / T. IBES VIA 3ª PONTE/RETA DA PENHA')
  WHERE numero_linha = 507;
  
alter table linha replace(desc_linha,'T. LARANJEIRAS / T. IBES VIA 3ª PONTE/RETA DA PENHA','T.LARANJEIRAS / T. IBES VIA 3ª PONTE/RETA DA PENHA');
